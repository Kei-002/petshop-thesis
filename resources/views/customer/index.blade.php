...
<body>
    <section style="padding-top:60px;">
        @csrf
        <div class="container">
            <h2 style="margin-top: 2%;">Customer Lists</h2><br/>
                    ...
                    <div class="col-xs-6">
                        <form method="post" enctype="multipart/form-data" action="{{ url('/customer/import') }}">
                            ...
                            @error('artist_upload')
                                <small>{{ $message }}</small>
                            @enderror
                            <button type="submit" class="btn btn-info" >Import Excel File</button>
                        </form> 
            </div> --}}
            ...
            <div>
                <div class="input-group mb-3">
                    <form method="post" enctype="multipart/form-data" action="{{ url('/customer/import') }}">
                        @csrf
                        <input type="file" class="form-control" id="uploadName" name="customer_upload" required>
                    ...
                    {{-- Modal Header --}}
                        ...
                        <div class="modal-body mx-3" id="inputCustomerModal">
                            <div class="md-form mb-5">
                                ...
                                width: 150px; ">Customer Name</label>
                                <input type="text" id="customer_name" class="form-control validate" name="customer_name">
                            </div>
