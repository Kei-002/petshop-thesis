...
<table id="u_content_heading_3" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 110%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Playfair Display',serif; font-size: 37px;">
    SangSang Tek Clinic<br /><strong>Pet Clinic and Grooming Service</strong>
  </h1>
<br/>
      </td>
    </tr>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{ $message->embed(public_path('images/logo.png')) }}" alt="Illustration" title="Illustration" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 76%;max-width: 456px;" width="456" class="v-src-width v-src-max-width"/>
...
<table id="u_content_text_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="line-height: 160%; text-align: justify; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%; text-align: center;"><strong><span style="font-family: 'Playfair Display', serif; font-size: 16px; line-height: 25.6px;"><span style="line-height: 25.6px; font-size: 16px;">Hi {{ $name }}!</span></span></strong></p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
<p style="font-size: 14px; line-height: 160%; text-align: center;">Welcome ! Thank You for Availing Services from our Clinic! Enjoy!</p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
<p style="font-size: 14px; line-height: 160%; text-align: center;">Pet Name {{ $petname }}!</p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
<p style="font-size: 14px; line-height: 160%; text-align: center;">Disease/Injury Observed : {{ $disease }}!</p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
<p style="font-size: 14px; line-height: 160%; text-align: center;">Consultation Fee : ${{ $consultfee }}!</p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
<p style="font-size: 14px; line-height: 160%; text-align: center;">Veterenarian Comment: {{ $comment }}!</p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
<p style="font-size: 14px; line-height: 160%; text-align: center;">Consultation Date : {{ $consultdate }}!</p>
<p style="font-size: 14px; line-height: 160%; text-align: center;"> </p>
  </div>
      </td>
    </tr>
...
<div id="u_row_3" class="u-row-container v-row-background-image--outer" style="padding: 0px;background-image: url('{{ asset('images/image-3.jpeg') }}');background-repeat: no-repeat;background-position: center top;background-color: #000000">
  <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
    <div class="v-row-background-image--inner" style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
      <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td class="v-row-background-image--outer" style="padding: 0px;background-image: url('images/image-3.jpeg');background-repeat: no-repeat;background-position: center top;background-color: #000000;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr class="v-row-background-image--inner" style="background-color: transparent;"><![endif]-->
...
<table id="u_content_social_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 52px;font-family:'Raleway',sans-serif;" align="left">
    ...
    <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 15px">
      <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
        <a href="https://twitter.com/" title="Twitter" target="_blank">
          <img src="{{ asset('images/image-5.png') }}" alt="Twitter" title="Twitter" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
        </a>
      </td></tr>
    </tbody></table>
    <!--[if (mso)|(IE)]></td><![endif]-->
...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;">SangSangTek</p>
  </div>
...
<table id="u_content_text_3" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;">Philippines</p>
<p style="font-size: 14px; line-height: 160%;">sst.admim@admin.com</p>
...
<table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-family: Raleway, sans-serif; font-size: 14px; line-height: 19.6px;">2022 © All Rights Reserved</span></p>
  </div>
